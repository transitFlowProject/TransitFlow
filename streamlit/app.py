...
def refresh_map():
    ...
    st.subheader(
        f"IMPORTANT: This demo app is no longer live. Live functionality can be recreated"
    )
    st.write(
        f"[Project GitHub](https://github.com/transitFlowProject/TransitFlow) | [Source data](https://data.bus-data.dft.gov.uk/) "
    )
